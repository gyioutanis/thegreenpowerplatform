        ...
        <div class="container px-6 py-10 mx-auto max-w-7xl">
            <div class="lg:flex lg:items-center">
                <div class="w-full space-y-12">
                    ...
                    <div class="mt-3 text-gray-500 dark:text-gray-300">theGreenpower Platform is now making these
                        integrated Web3 services available via an API as well as building out further dapps/apps to be
                        launched into our fast growing userbase around the world and specifically in China where we have
                        secured a partnership with the first government approved NFT exchange. China is the number 1
                        market in the world for football with over 400 million avid fans. Below are areas where we are
                        expanding:
                    </div>
                    ...
                    <div class="de_tab tab_simple tabs" style="background-size: cover;">
                        ...
                        <ul class="col-md-12 de_nav">
                            ...
                            <li class="tab-gra">theGreenpower Platform Trivia and Games
                            </li>
                            <li class="tab-gra">theGreenpower Platform blockchain ticketing
                            </li>
                            <li class="tab-gra">theGreenpower Platform fan DAO
                            </li>
                        </ul>
                            ...
                            <div class="tab-1" style="background-size: cover;">
                                ...
                                <span class="inline-block p-2 text-blue-500 bg-blue-100 rounded-xl md:mx-4 dark:text-white dark:bg-blue-500">
                                    ...
                                    <div class="mt-4 md:mx-4 md:mt-0">
                                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">TFA
                                            Wallet and Pay System</h1>

                                        <p class="mt-3 text-gray-500 dark:text-gray-300">
                                            theGreenpower Platform makes it easy for non-crypto people to hold and use
                                            tokens. theGreenpower Platform enables businesses to accept payment with
                                            tokens while avoiding volatility associated with crypto through its unique
                                            virtual stable coin credit system. Merchants get FIAT credits in the system
                                            for sales, then convert those credits to GPC at the moment they cash out -
                                            so price stays stable. Close to one hundred businesses in Cyprus accept GPC
                                ...
                                <span class="inline-block p-2 text-blue-500 bg-blue-100 rounded-xl md:mx-4 dark:text-white dark:bg-blue-500">
                                    ...
                                    <div class="mt-4 md:mx-4 md:mt-0">
                                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">
                                            theGreenpower Platform Trivia and Games</h1>
